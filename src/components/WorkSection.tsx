...
export function WorkSection() {
  return (
    <section
      ...
      "
    >
      {/* Full-bleed safety wrapper */}
      <div className="relative left-1/2 -translate-x-1/2 w-[100vw] max-w-none">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-14 sm:py-16">
