...
export function AudienceSection() {
  return (
    <section className="w-screen bg-[#E5F9E0] px-4 md:px-8 lg:px-12 py-16 overflow-x-hidden">
      
      {/* Main Content - Side by Side */}
      <div className="flex justify-between mb-32 w-full max-w-[1360px] h-[348px] mx-auto">
        {/* Left Column */}
        <div className="w-[740px] h-[348px] flex flex-col gap-4">
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: false, amount: 0.3 }}
            >
              Sprinten supports the people building the next generation of Solana
              products — whether you're writing smart contracts, shaping a new
              startup, or taking an idea to market.
            </motion.p>
          </motion.div>
